...
Odoo with SRI-ATS module by Modus S.A.
----

Odoo with SRI-ATS module is a suite of web based open source business apps.
...
Getting started with Odoo with SRI-ATS module
---------------------------------------------
...
Donwnload "sri_ats" folder module from this repository and copy to addons folder inside Odoo
